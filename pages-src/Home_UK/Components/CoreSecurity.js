...
const CoreSecurity = () => {
  ...
  const challenges = [
    ...
    "Limited real-time visibility across multi-site operations",
    "Growing retention & governance demands with complex storage policies",
    "Requirements for NDAA-compliant surveillance hardware & NDAA compliant cloud VMS",
    "Difficulty managing hybrid infrastructure (on-prem + cloud)",
    "Lack of analytics intelligence in traditional video surveillance system",
    "Increasing operational expenditure from legacy CCTV video monitoring",
    "Demand for scalable enterprise video surveillance system",
    "Need for automated video monitoring solutions and remote management"
  ];
        ...
        >
          <VStack align="flex-start" spacing={6}>
            <Heading
              ...
              textAlign="left"
            >
               UK Security Challenges Driving the Shift to {" "}
            ...
            <Text
              ...
              opacity={0.9}
            >
              Traditional video surveillance systems are no longer capable of supporting modern UK business risk environments. Organisations today face:
            </Text>
          </VStack>
